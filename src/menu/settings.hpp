...
public:
  ControllerPage(Gui2WindowManager *windowManager,
...
public:
  GamepadSetupPage(Gui2WindowManager *windowManager,
                   const Gui2PageData &pageData);
...
public:
  GamepadCalibrationPage(Gui2WindowManager *windowManager,
                         const Gui2PageData &pageData);
...
public:
  GamepadMappingPage(Gui2WindowManager *windowManager,
                     const Gui2PageData &pageData);
...
public:
  GamepadFunctionPage(Gui2WindowManager *windowManager,
                      const Gui2PageData &pageData);
  virtual ~GamepadFunctionPage();

  void OnClose();

  void SelectGpbutton(Gui2Button *button, Gui2Grid *grid,
