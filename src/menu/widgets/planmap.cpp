...
Gui2PlanMapEntry::Gui2PlanMapEntry(Gui2WindowManager *windowManager,
                                   const std::string &name, float x_percent,
                                   float y_percent, float width_percent,
  ...
  roleNameCaption = new Gui2Caption(windowManager, roleName + "role", 0, 0,
                                    width_percent, height_percent, roleName);
  this->AddView(roleNameCaption);
  roleNameCaption->Show();

  playerNameCaption =
      new Gui2Caption(windowManager, playerName + "name", 0, 2, width_percent,
