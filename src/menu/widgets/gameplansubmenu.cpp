...
GamePlanSubMenu::GamePlanSubMenu(Gui2WindowManager *windowManager,
                                 Gui2View *parentFocus, Gui2Grid *mainGrid,
                                 const std::string &name)
    : Gui2View(windowManager, name, 0, 0, 100, 100), mainGrid(mainGrid),
...
Gui2Button *GamePlanSubMenu::AddButton(const std::string &buttonName,
  ...
  Gui2Button *theButton = new Gui2Button(
      windowManager, "gameplan_button_submenu_" + name + "_" + buttonName, 0, 0,
      34, 3, buttonCaption);
...
Gui2Slider *GamePlanSubMenu::AddSlider(const std::string &sliderName,
                                       const std::string &sliderCaption,
                                       int row, int column) {
  Gui2Slider *theSlider = new Gui2Slider(
      windowManager, "gameplan_slider_submenu_" + name + "_" + sliderName, 0, 0,
      34, 6, sliderCaption);
