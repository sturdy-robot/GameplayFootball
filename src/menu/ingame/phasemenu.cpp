...
MatchPhasePage::MatchPhasePage(Gui2WindowManager *windowManager,
  ...
  buttonNext = new Gui2Button(windowManager, "button_next", 0, 0, 30, 3,
                              "begin " + phaseName);
  Gui2Button *button1 =
      new Gui2Button(windowManager, "button1", 0, 0, 30, 3, "game plan");

  buttonNext->sig_OnClick.connect(
      boost::bind(&MatchPhasePage::ContinueGame, this));
