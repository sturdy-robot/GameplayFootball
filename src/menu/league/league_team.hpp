...
public:
  LeagueTeamPage(Gui2WindowManager *windowManager,
...
public:
  LeagueTeamFormationPage(Gui2WindowManager *windowManager,
                          const Gui2PageData &pageData);
...
public:
  LeagueTeamPlayerSelectionPage(Gui2WindowManager *windowManager,
                                const Gui2PageData &pageData);
...
public:
  LeagueTeamTacticsPage(Gui2WindowManager *windowManager,
                        const Gui2PageData &pageData);
...
public:
  LeagueTeamPlayerOverviewPage(Gui2WindowManager *windowManager,
                               const Gui2PageData &pageData);
...
public:
  LeagueTeamPlayerDevelopmentPage(Gui2WindowManager *windowManager,
                                  const Gui2PageData &pageData);
...
public:
  LeagueTeamSetupPage(Gui2WindowManager *windowManager,
                      const Gui2PageData &pageData);
