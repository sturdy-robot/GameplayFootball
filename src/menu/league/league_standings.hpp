...
public:
  LeagueStandingsPage(Gui2WindowManager *windowManager,
...
public:
  LeagueStandingsLeaguePage(Gui2WindowManager *windowManager,
                            const Gui2PageData &pageData);
...
public:
  LeagueStandingsLeagueTablePage(Gui2WindowManager *windowManager,
                                 const Gui2PageData &pageData);
...
public:
  LeagueStandingsLeagueStatsPage(Gui2WindowManager *windowManager,
                                 const Gui2PageData &pageData);
...
public:
  LeagueStandingsNCupPage(Gui2WindowManager *windowManager,
                          const Gui2PageData &pageData);
...
public:
  LeagueStandingsNCupTreePage(Gui2WindowManager *windowManager,
                              const Gui2PageData &pageData);
...
public:
  LeagueStandingsNCupStatsPage(Gui2WindowManager *windowManager,
                               const Gui2PageData &pageData);
...
public:
  LeagueStandingsICup1Page(Gui2WindowManager *windowManager,
                           const Gui2PageData &pageData);
...
public:
  LeagueStandingsICup1TreePage(Gui2WindowManager *windowManager,
                               const Gui2PageData &pageData);
...
public:
  LeagueStandingsICup1StatsPage(Gui2WindowManager *windowManager,
                                const Gui2PageData &pageData);
...
public:
  LeagueStandingsICup2Page(Gui2WindowManager *windowManager,
                           const Gui2PageData &pageData);
...
public:
  LeagueStandingsICup2TreePage(Gui2WindowManager *windowManager,
                               const Gui2PageData &pageData);
...
public:
  LeagueStandingsICup2StatsPage(Gui2WindowManager *windowManager,
                                const Gui2PageData &pageData);
