...
LeagueTeamPage::LeagueTeamPage(Gui2WindowManager *windowManager,
                               const Gui2PageData &pageData)
    : Gui2Page(windowManager, pageData) {

  Gui2Caption *title = new Gui2Caption(windowManager, "caption_league_team", 20,
                                       20, 60, 3, "Team");
  this->AddView(title);
  title->Show();
...
LeagueTeamFormationPage::LeagueTeamFormationPage(
  ...
  Gui2Caption *title =
      new Gui2Caption(windowManager, "caption_league_team_formation", 20, 20,
                      60, 3, "Formation");
  this->AddView(title);
  title->Show();
...
LeagueTeamPlayerSelectionPage::LeagueTeamPlayerSelectionPage(
  ...
  Gui2Caption *title =
      new Gui2Caption(windowManager, "caption_league_team_playerselection", 20,
                      20, 60, 3, "Player selection");
  this->AddView(title);
  title->Show();
...
LeagueTeamTacticsPage::LeagueTeamTacticsPage(Gui2WindowManager *windowManager,
  ...
  Gui2Caption *title = new Gui2Caption(
      windowManager, "caption_league_team_tactics", 20, 20, 60, 3, "Tactics");
  this->AddView(title);
  title->Show();
...
LeagueTeamPlayerOverviewPage::LeagueTeamPlayerOverviewPage(
  ...
  Gui2Caption *title =
      new Gui2Caption(windowManager, "caption_league_team_playeroverview", 20,
                      20, 60, 3, "Player overview");
  this->AddView(title);
  title->Show();
...
LeagueTeamPlayerDevelopmentPage::LeagueTeamPlayerDevelopmentPage(
  ...
  Gui2Caption *title =
      new Gui2Caption(windowManager, "caption_league_team_playerdevelopment",
                      20, 20, 60, 3, "Player development");
  this->AddView(title);
  title->Show();
...
LeagueTeamSetupPage::LeagueTeamSetupPage(Gui2WindowManager *windowManager,
  ...
  Gui2Caption *title = new Gui2Caption(
      windowManager, "caption_league_team_setup", 20, 20, 60, 3, "Team setup");
  this->AddView(title);
  title->Show();
