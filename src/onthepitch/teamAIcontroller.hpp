...
bool SortTacticalOpponentInfo(const TacticalOpponentInfo &a,
...
public:
  ...
  Vector3 GetAdaptedFormationPosition(Player *player,
...
protected:
  ...
  Player
      *forwardSupportPlayer; // sort of like the attacking run player, but more
                             // for a forward offset for a player close to the
                             // action, to support the player in possession
