...
void PlayerOfficial::Activate(
  ...
  isActive = true;
  humanoid = new HumanoidBase(this, match, humanoidSourceNode,
                              fullbodySourceNode, colorCoords, animCollection,
                              match->GetDynamicNode(), kit, 0);
...
void PlayerOfficial::Deactivate() { PlayerBase::Deactivate(); }
