...
public:
  ...
  void AddDefensiveComponent(Vector3 &desiredPosition, float bias,
                             int forcedOppID = -1);
...
protected:
  ...
  virtual void _TrapCommand(PlayerCommandQueue &commandQueue,
                            bool idleTurnToOpponentGoal = false,
                            bool knockOn = false);
  virtual void _InterfereCommand(PlayerCommandQueue &commandQueue,
                                 bool byAnyMeans = false);
  virtual void _SlidingCommand(PlayerCommandQueue &commandQueue);
  virtual void _MovementCommand(PlayerCommandQueue &commandQueue,
