...
public:
  ...
  void
  SetGeometryData(boost::intrusive_ptr<Resource<GeometryData>> geometryData);
  ...
  virtual void ApplyForceAtRelativePosition(float force,
...
public:
  ...
  virtual void OnUpdateGeometry(boost::intrusive_ptr<Geometry> geometry,
                                bool updateMaterials) = 0;
