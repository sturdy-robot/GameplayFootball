...
public:
  ...
  void SetSize(float x_percent, float y_percent, float width_percent,
...
public:
  ...
  virtual void OnSpatialChange(const Vector3 &position,
                               const Quaternion &rotation);
  virtual void
  EnqueueView(const std::string &camName,
