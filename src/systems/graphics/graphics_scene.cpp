...
GraphicsSystem *GraphicsScene::GetGraphicsSystem() { return graphicsSystem; }
...
GraphicsScene::GetInterpreter(e_SceneType sceneType) {
...
ISystemObject *
GraphicsScene::CreateSystemObject(boost::intrusive_ptr<Object> object) {
  assert(object.get());
