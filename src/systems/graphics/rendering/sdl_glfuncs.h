...
SDL_PROC_UNUSED(void, glCopyTexSubImage1D,
                (GLenum target, GLint level, GLint xoffset, GLint x, GLint y,
                 GLsizei width))
SDL_PROC(void, glCopyTexSubImage2D,
...
SDL_PROC(void, glRenderbufferStorage,
...
SDL_PROC(void, glShaderSource,
         (GLuint shader, GLsizei count, const GLchar **string,
          const GLint *length))
...
SDL_PROC(void, glFramebufferTexture2D,
...
SDL_PROC(void, glFramebufferRenderbuffer,
...
SDL_PROC(void *, glMapBufferRange,
...
SDL_PROC(void, glDrawRangeElements,
