...
int VertexBuffer::CreateVertexBuffer(Renderer3D *renderer3D,
...
void VertexBuffer::SetID(int value) { vertexBufferID = value; }

int VertexBuffer::GetID() { return vertexBufferID; }
