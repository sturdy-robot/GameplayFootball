...
public:
  ...
  CreateCollisionPlane(int spaceID, const Vector3 &normal, float d);
  ...
  virtual IPhysicsCollisionMesh *CreateCollisionBox(int spaceID,
                                                    const Vector3 &sides);
  virtual IPhysicsCollisionMesh *
  CreateCollisionTriMesh(int spaceID, const float *vertices, int vertexCount);
  ...
  virtual void JointSetStops(IPhysicsJoint *joint, radian lowStop,
                             radian highStop, int paramNum = 1);
  ...
  virtual void JointSetErrorCorrection(IPhysicsJoint *joint, float value,
                                       int paramNum = 1);
  virtual void
  JointSetSuspensionConstraintForceMixing(IPhysicsJoint *joint,
  ...
  // utility
  void JointSetParameter(IPhysicsJoint *joint, int parameter, float value,
                         int paramNum = 1);
