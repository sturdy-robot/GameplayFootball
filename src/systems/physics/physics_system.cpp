...
e_SystemType PhysicsSystem::GetSystemType() const { return systemType; }

ISystemScene *
PhysicsSystem::CreateSystemScene(boost::shared_ptr<IScene> scene) {
...
ISystemTask *PhysicsSystem::GetTask() { return task; }

IPhysicsWrapper *PhysicsSystem::GetPhysicsWrapper() { return physicsWrapper; }
