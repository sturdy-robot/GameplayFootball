...
AudioSoundBuffer::~AudioSoundBuffer() { DeleteAudioSoundBuffer(); }
...
int AudioSoundBuffer::CreateAudioSoundBuffer(const WavData *wavData) {
  ...
  boost::intrusive_ptr<AudioRendererMessage_CreateAudioSoundBuffer>
      createAudioSoundBuffer(
...
void AudioSoundBuffer::DeleteAudioSoundBuffer() {
  if (audioSoundBufferID != -1) {
    assert(renderer);
    boost::intrusive_ptr<AudioRendererMessage_DeleteAudioSoundBuffer>
        deleteAudioSoundBuffer(new AudioRendererMessage_DeleteAudioSoundBuffer(
            audioSoundBufferID));
...
void AudioSoundBuffer::SetID(int value) { audioSoundBufferID = value; }

int AudioSoundBuffer::GetID() { return audioSoundBufferID; }
