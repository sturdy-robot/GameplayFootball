...
AudioSystem *AudioScene::GetAudioSystem() { return audioSystem; }

boost::intrusive_ptr<ISceneInterpreter>
AudioScene::GetInterpreter(e_SceneType sceneType) {
...
ISystemObject *
AudioScene::CreateSystemObject(boost::intrusive_ptr<Object> object) {
  assert(object.get());
...
AudioScene_Scene3DInterpreter::AudioScene_Scene3DInterpreter(AudioScene *caller)
    : caller(caller) {}
...
AudioScene_Scene2DInterpreter::AudioScene_Scene2DInterpreter(AudioScene *caller)
    : caller(caller) {}
