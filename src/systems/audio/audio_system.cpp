...
void AudioSystem::Initialize(const Properties &config) {
  ...
  ResourceManagerPool::GetInstance().RegisterManager(
      e_ResourceType_AudioSoundBuffer, audioSoundBufferResourceManager);
...
void AudioSystem::Exit() {
  ...
  boost::intrusive_ptr<Message_Shutdown> RendererShutdown(
...
e_SystemType AudioSystem::GetSystemType() const { return systemType; }
...
ISystemTask *AudioSystem::GetTask() { return 0; }

AudioRenderer *AudioSystem::GetAudioRenderer() { return rendererTask; }
