...
public:
  ...
  virtual void SetVertex(unsigned char pos, const real x, const real y,
                         const real z);
  virtual void SetVertex(unsigned char pos, const Vector3 &vec);
  virtual void Translate(const real x, const real y, const real z);
  virtual void SetTextureVertex(unsigned char pos, const real x, const real y,
                                const real z);
  virtual void SetTextureVertex(unsigned char texture_unit, unsigned char pos,
                                const Vector3 &xyz);
  virtual void SetTextureVertex(unsigned char texture_unit, unsigned char pos,
                                const real x, const real y, const real z);
  virtual void SetNormal(unsigned char pos, const real x, const real y,
                         const real z);
  ...
  virtual const Vector3 &GetTextureVertex(unsigned char texture_unit,
