...
public:
  Gui2Grid(Gui2WindowManager *windowManager, const std::string &name,
  ...
  virtual void UpdateLayout(float margin_left_percent = 0.5f,
                            float margin_right_percent = 0.5f,
                            float margin_top_percent = 0.5f,
                            float margin_bottom_percent = 0.5f);
