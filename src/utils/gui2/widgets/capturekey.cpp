...
Gui2CaptureKey::Gui2CaptureKey(Gui2WindowManager *windowManager,
...
int Gui2CaptureKey::GetKeyID() { return keyID; }
...
Gui2CaptureJoy::Gui2CaptureJoy(Gui2WindowManager *windowManager,
                               const std::string &name, int controllerID)
...
int Gui2CaptureJoy::GetButtonID() { return buttonID; }

int Gui2CaptureJoy::GetAxisID() { return axisID; }

signed int Gui2CaptureJoy::GetAxisSign() { return axisSign; }
