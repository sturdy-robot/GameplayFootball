...
Gui2Menu::Gui2Menu(Gui2WindowManager *windowManager, Gui2Menu *parentMenu,
                   const std::string &name, float x_percent, float y_percent,
                   float width_percent, float height_percent)
    : Gui2Frame(windowManager, name, x_percent, y_percent, width_percent,
                height_percent),
...
void Gui2Menu::Process() { Gui2View::Process(); }

void Gui2Menu::DecoupleParent() { parentMenu = 0; }

void Gui2Menu::_AddSubmenu(Gui2Menu *view) { subMenus.push_back(view); }
