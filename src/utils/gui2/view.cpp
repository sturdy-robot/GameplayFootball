...
Gui2View::Gui2View(Gui2WindowManager *windowManager, const std::string &name,
    ...
    : windowManager(windowManager), name(name), x_percent(x_percent),
...
void Gui2View::SetParent(Gui2View *view) { this->parent = view; }

Gui2View *Gui2View::GetParent() { return parent; }
...
void Gui2View::ProcessWindowingEvent(WindowingEvent *event) { event->Ignore(); }

void Gui2View::ProcessKeyboardEvent(KeyboardEvent *event) { event->Ignore(); }

void Gui2View::ProcessJoystickEvent(JoystickEvent *event) { event->Ignore(); }

bool Gui2View::IsFocussed() { return windowManager->IsFocussed(this); }

void Gui2View::SetFocus() { windowManager->SetFocus(this); }
