...
void Gui2Page::CreatePage(int pageID, const Properties &properties,
                          void *data) {
  this->Exit();
...
Gui2PageFactory::Gui2PageFactory() { mostRecentlyCreatedPage = 0; }
...
Gui2Page *Gui2PageFactory::CreatePage(int pageID, const Properties &properties,
                                      void *data) {
  Gui2PageData pageData;
  pageData.pageID = pageID;
  pageData.properties =
      boost::shared_ptr<Properties>(new Properties(properties));
  pageData.data = data;
