...
public:
  ...
  virtual float
  GetButtonValue(e_ButtonFunction buttonFunction); // for analog support
  ...
  void SetFunctionMapping(e_ButtonFunction buttonFunction,
                          e_ControllerButton controllerButton) {
    boost::mutex::scoped_lock blah(mutex);
  ...
  void SetControllerMapping(e_ControllerButton controllerButton,
                            signed int id) {
    boost::mutex::scoped_lock blah(mutex);
